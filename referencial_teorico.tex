...
\begin{itemize}
	...
	\item Suporte embutido para geração e exportação de \glspl{feed} em múltiplos formatos (como JSON, XML e CSV) e armazenamento dos mesmos (seja em FTP ou localmente).
