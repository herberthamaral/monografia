...
A seguir, duas avaliações são mostradas, quantitativas e qualitativas, dos resultados obtidos. Logo a seguir, há exemplos de spiders reais gerados a partir da ferramenta.
