...
Provas de conceitos são úteis para demonstração das principais funcionalidades da ferramenta, porém ainda são incompletos por não abordar situações reais de uso. 

Para fornecer melhores bases para avaliação deste trabalho, a seguir são apresentadas algumas formas de uso da ferramenta desenvolvida.
...
Seguindo as especificações do Website Parse Template (WPT), o template necessário para obter a lista de notícias com seus respetivos atributos se encontra na listagem \ref{wpt_minc}
